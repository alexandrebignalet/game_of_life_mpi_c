...
plot [0.9:150][0:$prob] \
	 "./benchmarks/data-files/temps-$taille-$nbsteps.txt" using 1:(\$1) title "seq" with linespoints ls 1,\
	 "./benchmarks/data-files/temps-$taille-$nbsteps.txt" using 1:(\$2) title "line block" with linespoints ls 2
EOF