...
mesures: $(MESURE)
	...
	$(RUN) -np 4 ./$(MESURE)    10000 100 2 5 1  >> ./benchmarks/data-files/temps-10000-100-4.txt
	$(RUN) -np 8 ./$(MESURE)    10000 100 2 5 1  >> ./benchmarks/data-files/temps-10000-100-8.txt
	$(RUN) -np 10 ./$(MESURE)   10000  100 2 5 1 >> ./benchmarks/data-files/temps-10000-100-10.txt
	$(RUN) -np 20 ./$(MESURE)   10000  100 2 5 1 >> ./benchmarks/data-files/temps-10000-100-20.txt
	$(RUN) -np 40 ./$(MESURE)   10000  100 2 5 1 >> ./benchmarks/data-files/temps-10000-100-40.txt
	$(RUN) -np 50 ./$(MESURE)   10000  100 2 5 1 >> ./benchmarks/data-files/temps-10000-100-50.txt
	$(RUN) -np 100 ./$(MESURE)  10000  100 2 5 1 >> ./benchmarks/data-files/temps-10000-100-100txt
